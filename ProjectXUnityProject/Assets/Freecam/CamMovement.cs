...
public class CamMovement : MonoBehaviour
{
    ...
    public float minCamZoom, maxCamZoom;
    ...
    void Update()
    {
        ...
        if (scroll != 0) 
        {
            if (scroll > 0 && cam.orthographicSize > minCamZoom || scroll < 0 && cam.orthographicSize < maxCamZoom) cam.orthographicSize -= (scroll * camZoomSpeed);
        }
